...
<section id="cart" class="py-3 mb-5">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="qty d-flex pt-2">
                            <div class="d-flex font-rale w-15">
                                <button class="qty-up border-0 bg-white" data-id="<?php echo $row['productID'] ?? '0'; ?>"><img src="./assets/blog/plus.png" alt="plus Cart"></button> <!--<i class="fas fa-angle-up"></i>-->
                                ...
                                <button data-id="<?php echo $row['productID'] ?? '0'; ?>" class="qty-down border-0 bg-white"> <img src="./assets/blog/minus.png" alt="minus Cart"></button> <!--<i class="fas fa-angle-down"></i>-->
    ...
    <!-- subtotal section-->
    <div class=" container-fluid w-100 px-0 sticky_lej">
